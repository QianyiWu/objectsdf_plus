...
parser.set_defaults(omnidata_path='/media/hdd/omnidata/omnidata_tools/torch/')

parser.add_argument('--pretrained_models', dest='pretrained_models', help="path to pretrained models")
parser.set_defaults(pretrained_models='/media/hdd/omnidata/omnidata_tools/torch/pretrained_models/')
