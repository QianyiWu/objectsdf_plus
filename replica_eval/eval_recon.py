...
def calc_3d_metric(rec_meshfile, gt_meshfile, align=False):
    ...
    print('Acc: ', accuracy_rec, 'Comp:', completion_rec, 'Rrecision: ', precision_ratio_rec, 'Comp_ratio: ', completion_ratio_rec, 'F_score: ', fscore, 'Normal_acc: ', normal_acc, 'Normal_comp: ', normal_comp, 'Normal_avg: ',normal_avg)
